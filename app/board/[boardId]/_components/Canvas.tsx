...
export const Canvas = ({ boardId }: CanvasProps) => {
  ...
  // NOTE: The previous useEffect that directly modified document.body has been removed
  // to fix React 19 hydration and layout thrashing issues.
  // Scroll locking is now handled directly by the <main> tag's CSS classes below.
  ...
  // FIX APPLIED HERE: Changed h-full to h-screen and added overflow-hidden & overscroll-none directly to <main>
  return (
    <main className="w-full h-screen relative bg-neutral-100 dark:bg-neutral-400 touch-none overflow-hidden overscroll-none">
